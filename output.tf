output "cost_allocation_tag_filter" {
  value = aws_cloudwatch_log_metric_filter.CostAllocationTagFilter.id
}
...
output "cost_allocation_tag_filter_name" {
  value = aws_cloudwatch_log_metric_filter.CostAllocationTagFilter.name
}
...
output "cost_allocation_tag_alarm_name" {
  value = aws_cloudwatch_metric_alarm.CostAlloactionTagAlarm.alarm_name
}
